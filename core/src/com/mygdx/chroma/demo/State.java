...
public class State 
{
    ...
    public static boolean[][] traveledMap;
    public static boolean[][] foundMap;
    public static boolean[][] hiddenMap;


    /** The default constructor. Creates a randomized game in its start state. */
    public State()
    {
	traveledMap=new boolean[Constants.GRID_SIZE][Constants.GRID_SIZE];
	foundMap=new boolean[Constants.GRID_SIZE][Constants.GRID_SIZE];
	hiddenMap=new boolean[Constants.GRID_SIZE][Constants.GRID_SIZE];
